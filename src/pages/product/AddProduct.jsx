...
import {AlignLeft, Coins, Image as ImageIcon, MapPin, PackagePlus, Tag} from 'lucide-react';
                ...
                <div className="add-card">
                    ...
                    <form onSubmit={handleSubmit} className="add-form">
                        <div className="form-section">
                            ...
                            <input type="text" placeholder="Ex: iPhone 15" value={formData.name}
                        ...
                        <div className="form-section">
                            ...
                            <input type="text" placeholder="https://link-imagine.jpg" value={formData.imageUrl}
                        ...
                        <div className="form-section">
                            ...
                            <input type="text" placeholder="Orașul tău" value={formData.location}
                                   onChange={(e) => setFormData({...formData, location: e.target.value})} required/>
                        </div>

                        <div className="form-section">
                            <label><AlignLeft size={18}/> Descriere</label>
                            <textarea rows="4" placeholder="Detalii..." value={formData.description}
